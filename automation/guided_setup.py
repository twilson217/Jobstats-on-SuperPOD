...
class GuidedJobstatsSetup:
    ...
    def section_cgroups(self):
        ...
        self._add_to_document("")
        self._add_to_document("- 2a. Edit slurm.conf")
        ...
        # Subsection 2a: Edit slurm.conf
        print(f"\n{Colors.BOLD}{Colors.CYAN}2a. Edit slurm.conf{Colors.END}")
        self._add_to_document("### 2a. Edit slurm.conf")
        self._add_to_document("")
...
echo "Example vim command: vim {slurm_conf_path}"''',
        ...
        # Subsection 2b: Deploy cgroup_exporter
        print(f"\n{Colors.BOLD}{Colors.CYAN}2b. Deploy cgroup_exporter{Colors.END}")
        self._add_to_document("### 2b. Deploy cgroup_exporter")
        self._add_to_document("")
